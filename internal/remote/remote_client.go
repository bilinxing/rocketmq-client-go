...
//go:generate mockgen -source remote_client.go -destination mock_remote_client.go -self_package github.com/bilinxing/rocketmq-client-go/v2/internal/remote  --package remote RemotingClient
...
func (c *remotingClient) processCMD(cmd *RemotingCommand, r *tcpConnWrapper) {
	if cmd.isResponseType() {
		...
		if f != nil {
			...
			// TODO: optimize with goroutine pool, https://github.com/bilinxing/rocketmq-client-go/v2/issues/307
			go primitive.WithRecover(func() {
