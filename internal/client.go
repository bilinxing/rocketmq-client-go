...
import (
	...
	errors2 "github.com/bilinxing/rocketmq-client-go/v2/errors"
	"github.com/bilinxing/rocketmq-client-go/v2/internal/remote"
	"github.com/bilinxing/rocketmq-client-go/v2/internal/utils"
...
//go:generate mockgen -source client.go -destination mock_client.go -self_package github.com/bilinxing/rocketmq-client-go/v2/internal  --package internal RMQClient
